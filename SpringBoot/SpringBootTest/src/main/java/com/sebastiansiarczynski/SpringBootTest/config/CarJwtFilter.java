...
public class CarJwtFilter extends OncePerRequestFilter {

  private static final String AUTHORIZATION_HEADER_NAME = "X-Car-Authorization";
  private static final String CLAIM_ROLE_NAME = "CAR-SCOPE-ROLE";
  ...
  protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
    ...
    System.out.println("STARTED CAR JWT FILTER");
    ...
    System.out.println("ENDED CAR JWT FILTER");
  }

  @Override
  protected boolean shouldNotFilter(HttpServletRequest request) throws ServletException {
    System.out.println("CAR FILTER URI: " + request.getRequestURI());
    return !request.getRequestURI().startsWith("/car");
  }
}
